...
namespace 中国数字书法
{
    public partial class Form_yz : Form
    {
        ...
        public Form_yz()
        {
            ...
            //加载登录背景
            this.BackgroundImage = Image.FromFile(strSub + "\\image\\bj\\yzbj.jpg");
        ...
        private void btn_yzdl_Click(object sender, EventArgs e)
        {
            //取消音乐背景
            this.axWindowsMediaPlayer1.URL = null;
            this.axWindowsMediaPlayer1.Visible = false;

            if (Toolimp.IsAppInCDRom())
            {
                //读取光盘中的验证码，验证码正确进入系统
